...
describe("wehelpjs.auth: operation test", ()=> {
    ...
    it("accountCreate", ()=> {
        let tx = {"ref_block_num": 19297,"ref_block_prefix": 1608085982,"expiration": "2016-03-23T22:41:21","operations": [ ["accountCreate",{"fee": "0.000 TME","creator": "initminer","newAccountName": "scott","owner": {"weight_threshold": 1,"account_auths": [],"key_auths": [ ["TME7DTS62msowgpAZJBNRMTMEUt5bfRA4hc9j5wjwU4vKhi3KFkKb",1 ]]},"active": {"weight_threshold": 1,"account_auths": [],"key_auths": [ ["TME8k1f8fvHxLrCTqMdRUJcK2rCE3y7SQBb8PremyadWvVWMeedZy",1 ]]},"posting": {"weight_threshold": 1,"account_auths": [],"key_auths": [ ["TME6DgpKJqoVGg7o6J1jdiP45xxbgoUg5VGzs96YBxX42NZu2bZea",1 ]]},"memoKey": "TME6ppNVEFmvBW4jEkzxXnGKuKuwYjMUrhz2WX1kHeGSchGdWJEDQ","json": ""} ]],"extensions": [], "signatures": []}
        ...
        assert.equal("TME", new Buffer("535445454d", "hex").toString())
